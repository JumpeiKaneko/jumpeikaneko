...
現状、サイトに掲載しているのは以下の7作品です。

- 絵画を聴く（インスタレーション）
- ミキキの交差点（内容は「気配に触れる」との共同企画だが、表示名は「ミキキの交差点」のみ）
- 線を聴く
- 聴く絵画をつくる（ワークショップ）
- Resonance
- 耳を澄ますための装置
...
「ミキキの交差点」「線を聴く」の2つは、いずれも「絵画を聴く」から派生した実践だが、
開催場所・形式が異なるため独立ページにした。各ページの冒頭リンクと、絵画を聴くページの
「関連展示」セクションから相互にたどれる。
「VR学会論文」は独立ページを作らず、展示・受賞歴のリストにのみ関連情報として掲載している。

※ `work-detail-hachioji.html`（東京都盲人福祉協会での鑑賞会）と`work-detail-mikiki.html`
（旧・分割版）は、どこからもリンクされていない未使用ファイルです。削除してよければ
お知らせください。
